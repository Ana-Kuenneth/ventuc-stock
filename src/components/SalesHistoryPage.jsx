            ...
            {sales
              ...
              .map((sale, index) => (
                <tr key={index}>
                  ...
                  <td>{sale.quantity}</td>
                  <td>${sale.salePrice ? sale.salePrice.toFixed(2) : 0}</td>
                  <td>${sale.incremento ? sale.incremento.toFixed(2) : 0}</td>
                  <td>{sale.descripcionIncremento || "N/A"}</td>
